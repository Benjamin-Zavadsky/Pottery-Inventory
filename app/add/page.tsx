    ...
    try {
      ...
      const { data, error: insertError } = await supabase
        ...
        .insert({
          ...
          case_id: CASE_IDS.includes(form.case_id as (typeof CASE_IDS)[number])
            ? form.case_id
            : null,
          museums_comparable: form.museums_comparable || null,
          provenance: form.provenance || null,
          research_notes:
            form.research_notes || description
      ...
      <div className="min-h-screen flex flex-col bg-[#f9f9f9]">
        ...
        <main className="flex-1 max-w-2xl mx-auto w-full px-4 sm:px-6 py-4 sm:py-8 pb-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <section className="bg-white border border-[#e5e5e5] rounded-2xl overflow-hidden">
                <div className="px-6 pt-6 pb-4 text-center">
                  <p className="text-sm font-medium text-[#111]">
                    How would you like to photograph this piece?
                  </p>
                  <p className="text-xs text-[#6b6b6b] mt-1">
                    Multiple photos give Claude more angles for a more accurate analysis
                  </p>
                </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs text-[#6b6b6b] mt-1">
                        {photoMode === 'single'
                          ...
                          : 'Add all angles, then run analysis'}
                      </p>
                    </div>
                    <input
                      type="file"
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {previews.map((src, i) => (
                        <div
                          key={i}
                          className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden border border-[#e5e5e5]"
                        >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Field label="Provenance">
                  <input
                    ...
                    placeholder="Chain of ownership"
                    className={inputClass}
                  />
                </Field>
            ...
            {/* ── Description ── */}
            <section className="bg-white border border-[#e5e5e5] rounded-2xl p-4 sm:p-6">
              <label className="text-xs text-[#6b6b6b] uppercase tracking-wider block mb-3">
                Description
              </label>
              <textarea
                value={description}
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-xs text-[#6b6b6b] uppercase tracking-wider">
        {label}
        {required && <span className="text-[#111] ml-0.5">*</span>}
      </label>
      {children}
    </div>
  );
